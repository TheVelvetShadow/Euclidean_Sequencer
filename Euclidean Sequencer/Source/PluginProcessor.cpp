...
#include "PluginEditor.h"
    ...
    // Run unit tests on plugin load in debug builds
...
{
#if JUCE_DEBUG && JUCE_UNIT_TESTS
       // Run tests on startup in debug mode
       juce::UnitTestRunner testRunner;
       testRunner.setAssertOnFailure(false); // Don't crash, just log
       
       // Run all tests and log results
       auto results = testRunner.runAllTests();
       
       DBG("=== Unit Test Results ===");
       DBG("Tests run: " << testRunner.getNumResults());
       DBG("Tests passed: " << (testRunner.getNumResults() - results));
       DBG("========================");
#endif
}
